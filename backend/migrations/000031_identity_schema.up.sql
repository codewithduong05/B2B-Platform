...
-- NOTE: 000002 already creates the canonical identity schema.
-- This migration preserves the alternate identity design for historical purposes.
-- Wrapped in exception-safe blocks so it can coexist with 000002.
